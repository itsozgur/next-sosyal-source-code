...
class Quoters extends ImmutablePureComponent {
  ...
  render () {
    const { intl, statusIds, hasMore, isLoading, multiColumn } = this.props;
...
export default connect(mapStateToProps)(injectIntl(Quoters)); 