      ...
      <div className='modal-root__modal interaction-modal'>
        ...
        <div className='interaction-modal__choices'>
          ...
          <div className='interaction-modal__choices__choice'>
            ...
            <a href='https://joinmastodon.org/servers' className='button button--block' data-testid="index-block-a"><FormattedMessage id='closed_registrations_modal.find_another_server' defaultMessage='Find another server' /></a>
          </div>
        </div>
      </div>
    );
