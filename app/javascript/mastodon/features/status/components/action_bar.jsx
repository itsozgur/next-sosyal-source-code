...
import RetweetDropdown from '../../../components/retweet_dropdown';
      ...
      <div className='detailed-status__action-bar'>
        ...
        <div className='detailed-status__button'>
          {window.location.hostname === 'sosyal.teknofest.app' ? (
            <IconButton className='star-icon' animate active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='star' iconComponent={status.get('favourited') ? RocketIcon : RocketBorderIcon} onClick={this.handleFavouriteClick} />
          ):(
            this.state.animatingStatuses.has(status.get('id')) ? (
              ...
              <IconButton className='star-icon' animate active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon='star' iconComponent={status.get('favourited') ? StarIcon : StarBorderIcon} onClick={this.handleFavouriteClick} />
            )
