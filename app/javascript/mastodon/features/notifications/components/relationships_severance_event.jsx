  ...
  return (
    <div role='button' className={classNames('notification-group notification-group--link notification-group--relationships-severance-event focusable', { 'notification-group--unread': unread })} tabIndex='0'>
      ...
      <div className='notification-group__main'>
        ...
        <a href='/severed_relationships' target='_blank' rel='noopener noreferrer' className='link-button' data-testid="relationships_severance_event-show-a"><FormattedMessage id='notification.relationships_severance_event.learn_more' defaultMessage='Learn more' /></a>
      </div>
    </div>
  );
};
