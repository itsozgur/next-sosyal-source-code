      ...
      <div className='notification__report'>
        ...
        <div className='notification__report__details'>
          ...
          <div className='notification__report__actions'>
            <a href={`/admin/reports/${report.get('id')}`} className='button' target='_blank' rel='noopener noreferrer' data-testid="report-show-a">{intl.formatMessage(messages.openReport)}</a>
          </div>
        </div>
      </div>
    );
